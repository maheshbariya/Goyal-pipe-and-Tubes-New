...
function animateOnScroll() {
    const elements = document.querySelectorAll('.industry-card, .feature-card, .product-card, .testimonial-card, .process-step, .content-card, .trust-stat, .contact-method');
...
document.addEventListener('DOMContentLoaded', function() {
    const cards = document.querySelectorAll('.industry-card, .feature-card, .product-card, .testimonial-card');
